...
(function (characters) {
    characters.gwen = {
        ...
        attacks: [
            ...
            { speed: 3.6, rank: "J", pumpWith: "+J", name: "Chains of Ice", damage: 7, pump: 7, chip: 5, maxCombo: "J+>K++>A+", maxDamage: 42, goodCombo: "J+>3>4>5>6", goodDamage: 32, notes: "Unburstable due to Chillbane" },
            { speed: 4.0, rank: "J", name: "Links of Ice", damage: 6, chip: 1, maxCombo: "J>6>K++>A+", maxDamage: 40, goodCombo: "J>2>3>4>5>6", goodDamage: 26 },
            { speed: 0.0, rank: "Q", pumpWith: "+X", damage: 6, pump: 4, chip: 1, maxCombo: "Q+", maxDamage: 10 },
            { speed: 1.2, rank: "K", pumpWith: "+X+X", damage: 4, pump: 4, chip: 3, maxCombo: "K++>K++>A+", maxDamage: 40, goodCombo: "K++>3>4>5>6", goodDamage: 30 },
            {
